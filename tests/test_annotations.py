"""Both tools declare what they do, and only one of them leaves this process.
...
async def test_both_tools_are_present(tools):
    """Guards the guard: an empty manifest would pass everything below."""
    assert set(tools) == {"fetch_transcript", "format_transcript_as_research"}
